...
tekst = " Call me if you have any questions 6. i will work to get the revised estimates work into pops today. "
print(tekst)
...
# 5. filtert alle stopwoorden die niet belangrijk zijn uit een string
